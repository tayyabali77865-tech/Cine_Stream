...
async function testSelfReferer() {
  try {
    ...
    console.log('Stream Origin:', streamUrlObj.origin);

    // Test with Referer set to the stream origin itself
    ...
    console.log('Status with Self-Referer:', res.status, res.statusText);
  } catch (err) {
    console.error(err);
  }
}
